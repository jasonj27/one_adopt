class Animal < ApplicationRecord
  ...
  enum animal_kind: { "貓": 1, "狗": 2, "兔": 3, "鼠": 4 }
  enum animal_sex: { "公": 1, "母": 2, "還未輸入": 3 }
  enum animal_age: { "幼年": 1, "成年": 2, "未知": 3 }
  ...
  enum animal_colour: { "三花色": 1, "白色": 2, "灰色": 3, "灰白色": 4, "灰黑色": 5, "米色": 6, "咖啡色": 7, "咖啡白色": 8, "咖啡棕色": 9, "咖啡黑色": 10, "花色": 11, "花白色": 12, "虎斑色": 13, "虎斑白色": 14, "棕色": 15, "棕白色": 16, "棕灰色": 17, "棕黑色": 18, "黃色": 19, "黃白色": 20, "黃虎斑色": 21, "黑色": 22, "黑白色": 23, "黑灰色": 24, "黑虎斑色": 25, "黑棕色": 26, "黑黃色": 27, "未知色": 28 }
